...
var ADDR_RESUME_REVIEW  = ['bio', 9, 1];
...
var EMAILS = {
  ...
  "meetinghappened":[
    "Здравствуйте{#name}!\nСпасибо, что пришли на собеседование. Я рассмотрю результаты собеседования и всех предварительных заданий в сравнении с другими кандидатами и сообщу Вам о своем решении. \n\nПожалуйста, наберитесь терпения"  
  ],
  "hired":[
    "Здравствуйте{#name}!\nЯ с радостью спешу сообщить Вам, что мы приглашаем Вас занять текущую вакансию в нашей компании. Если Вы готовы принять неше предложение, то позвоните по телефону 8-701-559-44-05, чтобы обсудить все детали"  
  ],
  "declinedByCompany":[
    "Здравствуйте{#name}!\nМне очень жаль, что мы не можем предложить Вам занять данную должность. Однако, у нас много интересной работы и увлектельных задач. Посетите наш портал по адресу http://ains.kz/hr \nЕсли Вы решите, что готовы попробовать себя в одной из вакансий - смело откликайтесь. "  
  ],
  "declinedByEmployee":[
    "Здравствуйте{#name}!\nСпасибо, что уделили нам время. Вы можете продолжать следить за нашими вакансиями по адресу http://ains.kz/hr"  
  ],
